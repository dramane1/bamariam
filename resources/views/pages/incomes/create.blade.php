            ...
            <div class="row">
                <div class="col-12">
                    <div class="card m-b-30">
                        <div class="card-body ">
                            <form action="{{ route('incomes.store') }}" method="POST" id="myform" enctype="multipart/form-data" >
                                @csrf
                                ...
                                <div id="contact_fields">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" name="income_amount" class="form-control {{ $errors->has('income_amount') ? 'is-invalid' : '' }}" id="income_amount" value="{{ old('income_amount') ?? '' }}" placeholder="Ex: 25000">
