            ...
            <div class="row">
                <div class="col-12">
                    <div class="card m-b-30">
                      ...
                      @endif
                            <form action="{{ route('expenses.update',$expense) }}" method="POST" id="myform" enctype="multipart/form-data" >
                                @csrf
                                {{ method_field('PUT') }}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="expense_at" id="expense_at" value="<?php echo date('Y-m-d'); ?>" class="form-control form-control-alternative"  value="{{ old('expense_at') }}">
                                        ...
                                        <div id="Carburant">
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" name="expense_amount" class="form-control {{ $errors->has('expense_amount') ? 'is-invalid' : '' }}" id="expense_amount" value="{{ old('expense_amount') ?? $expense->expense_amount }}" placeholder="Ex: 25000">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" name="description" class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" id="description" value="{{ old('description') ?? $expense->description }}" placeholder="">
                                ...
                                <div id="contact_uploads">
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" name="event_type" class="form-control {{ $errors->has('event_type') ? 'is-invalid' : '' }}" id="event_type" value="{{ old('event_type') ?? $expense->event_type }}" placeholder="Ex: Type d'evenement">
